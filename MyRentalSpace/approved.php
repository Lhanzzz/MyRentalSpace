...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="button">
            ...
            <a href="approved.php" id="activebutton"><i class="fa-solid fa-gauge" ></i>Approved</a>
        ...
        <main>
            ...
            <table id="myTable">
                ...
                <tbody>
                    ...
                    <?php 
                    $result = mysqli_query($conn, "SELECT * FROM approve WHERE author_id ='$id'");
                            while($row = mysqli_fetch_assoc($result))
                            {
                                ...
                                <td>".$row['date']."</td>
                                <td>".$row['time']."</td>
                                <td><a href='php/markasdone.php?id=".$row['id']."'>Mark as Done</a><a href='php/cancel.php?id=".$row['id']."'>CANCEL</a></tr>
                                ";
                            }

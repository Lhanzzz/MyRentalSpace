...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="button">
            ...
            <a href="cancelled.php" id="activebutton"><i class="fa-solid fa-gauge" ></i></i>Cancelled</a>
        ...
        <main>
            ...
            <table id="myTable">
                ...
                <tbody>
                    ...
                    <?php 
                    $result = mysqli_query($conn, "SELECT * FROM cancelled WHERE author_id ='$id'");
                            while($row = mysqli_fetch_assoc($result))
                            {
                                ...
                                <td>".$row['date']."</td>
                                <td>".$row['time']."</td>
                                <td><a href='php/approve.php?id=".$row['id']."'  >CANCELLED</a></tr>
                                ";
                            }

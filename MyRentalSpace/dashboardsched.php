...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="button">
            ...
            <a href="dashboardsched.php" id="activebutton" ><i class="fa-solid fa-gauge"></i>Pending</a>
        ...
        <main>
            ...
            <table id="myTable">
                ...
                <tbody>
                    ...
                    <?php 
                    $result = mysqli_query($conn, "SELECT * FROM approval WHERE author_id ='$id'");
                            while($row = mysqli_fetch_assoc($result))
                            {
                                ...
                                <td>".$row['date']."</td>
                                <td>".$row['time']."</td>
                                <td><a href='php/approve.php?id=".$row['id']."'  >APPROVE</a><a href='php/cancel1.php?id=".$row['id']."'>CANCEL</a></tr>
                                ";
                            }
